 ...
 */
class Faqs extends BaseActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('portal_id, question, answer', 'required'),
            array('ordi', 'numerical', 'integerOnly' => true),
            array('question', 'length', 'max' => 500),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, question, answer, ordi', 'safe', 'on' => 'search'),
        );
    }
