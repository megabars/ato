...
<div class="form-left">
    <?php if (!$model->isNewRecord): ?>
        <a href="<?php echo $this->createUrl('/news/front/view', array('id' => $model->id)); ?>" target="_blank" class="fr link">Показать страницу</a>
    <?php endif; ?>
...
<div class="form-right">
    ...
    <div class="row">
        <?php echo $form->dropDownList($model, 'default_image', array('') + ImageType::instance()->list); ?>
    </div>
</div>
<?php $this->endWidget(); ?>
</div>