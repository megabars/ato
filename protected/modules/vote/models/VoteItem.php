 ...
 */
class VoteItem extends BaseActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('vote_id, title', 'required'),
            array('vote_id, sort', 'numerical', 'integerOnly' => true),
            array('title', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, vote_id, title, sort', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'voteUsers' => array(self::HAS_MANY, 'VoteUser', 'vote_item_id'),
            'answersCount' => array(self::STAT, 'VoteUser', 'vote_item_id'),
        );
    }
