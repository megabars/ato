 ...
 */
class GalleryAudios extends BaseActiveRecord
{
    /**
    ...
    {
        return 'audio'; //todo переименовать таблицу в gallery_audios
    }
    ...
    public function beforeSave()
    {
        ...
        {
            $streamer = new AudioStreamer($file, 'C:\Users\user\Downloads\ffmpeg-20141201-git-928322c-win64-static\ffmpeg-20141201-git-928322c-win64-static\bin\ffmpeg.exe');
