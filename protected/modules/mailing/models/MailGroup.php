 ...
 */
class MailGroup extends BaseActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
            ...
            array('alias', 'unique', 'message' => 'Данный адрес страницы уже используется. Попробуйте ввести уникальный адрес'),
	...
	public function relations()
	{
		...
		return array(
			'emails' => array(self::HAS_MANY, 'MailGroupEmailList', 'group_id'),
		);
	}
