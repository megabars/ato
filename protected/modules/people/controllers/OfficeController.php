...
{
    public $people=0;
    public $type=People::DEPARTMENTS;
    ...
    public function init(){
        $this->pageTitle = 'Ведомства';
        $this->breadcrumbs = array(
            $this->pageTitle => array('/people/office'),
        );
        return parent::init();
    }
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/office/update/people_id/'.$people_id));
        }
    ...
    public function actionDelete($id)
    {
        ...
        if (!isset($_GET['ajax']))
            $this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/people/office'));
    }
