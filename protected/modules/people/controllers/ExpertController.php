...
class ExpertController extends AdminController
{
    ...
    public function init(){
        $this->pageTitle = 'Экспертный совет';
        $this->breadcrumbs = array(
            $this->pageTitle=>array('/people/expert'),
        );
        return parent::init();
    }
...
//                throw new CHttpException(404, 'Для данного района уже создан глава органа местного самоуправления.');
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/expert/update/people_id/'.$people_id));
        }
