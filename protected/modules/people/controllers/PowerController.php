...
class PowerController extends AdminController
{
    ...
    public function init(){
        $this->pageTitle = People::getTypeLabels(People::POWER);
        $this->breadcrumbs = array(
            $this->pageTitle=>array('/people/power'),
        );
        return parent::init();
    }
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/power/update/people_id/'.$people_id));
        }
