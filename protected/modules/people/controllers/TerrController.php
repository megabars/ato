...
class TerrController extends AdminController
{
    public $people=0;
    public $type=People::TERR;
    ...
    public function init(){
        $this->pageTitle = 'Территориальные органы федеральных органов власти';
        $this->breadcrumbs = array(
            $this->pageTitle=>array('/people/terr'),
        );
        return parent::init();
    }
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/terr/update/people_id/'.$people_id));
        }
