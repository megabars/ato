...
class IogvController extends AdminController
{
    public $people=0;
    public $type=People::GOVERNMENT;
    ...
    public function init(){
        $this->pageTitle = 'Глава органа местного самоуправления';
        $this->breadcrumbs = array(
            $this->pageTitle=>array('/people/iogv'),
        );
        return parent::init();
    }
...
//            if (in_array($model->type,array_keys(People::getTypeGroupLabels(People::GOVERNMENT))))
//                throw new CHttpException(404, 'Для данного района уже создан глава органа местного самоуправления.');
...
//                throw new CHttpException(404, 'Для данного района уже создан глава органа местного самоуправления.');
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/iogv/update/people_id/'.$people_id));
        }
