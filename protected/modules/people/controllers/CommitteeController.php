...
class CommitteeController extends AdminController
{
    ...
    public function init(){
        $this->pageTitle = 'Комитеты и отделы';
        $this->breadcrumbs = array(
            $this->pageTitle=>array('/people/committee'),
        );
        return parent::init();
    }
    ...
    public function actionLife($people_id)
    {
        ...
        if (isset($_POST['People']))
        {
            ...
            if ($model->save())
                $this->redirect(array('/people/committee/update/people_id/'.$people_id));
        }
