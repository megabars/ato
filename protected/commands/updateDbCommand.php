...
class updateDbCommand extends CConsoleCommand
{
    ...
    public $GENERATE_FK_IDX = true; //flag to control if the indexes should be automatically generated for each fk
    ...
    */
    ...
    public function upIndex($idx){
        if($idx["status"]==$this->NEW){
            ...
            $this->log("* Table '".$idx["table"]."' -> Dropped Fk: '".$idx["name"]."'");
    ...
    function xmlObj2array($xml){
        ...
        foreach ($xml->children() as $r){
            ...
            if(count($r->children()) == 0){
                ...
                $arr[$r->getName()][] = $this->xmlObj2array($r);
            }
        }
        return $arr;
    }
