...
<div class="wrap">
        ...
        if(!empty($news))
            $this->widget('zii.widgets.jui.CJuiTabs',array(
                'tabs'=> array(
                    ...
                    'Фото' => !empty($gallery)?$this->widget('zii.widgets.CListView', array(
    ...
    <div class="block-link">
        <ul>
            <li>
                <a class="item" href="/experts/database">
                    <span class="image">
    ...
    $this->widget('application.modules.afisha.widgets.LatestEventsWidget', array(
        'limit' => 2,
    ));
    ?>
