                        ...
                        array(
                            ...
                            'value'=>function ($data) {
                                return '<div>'.$data->title.'</div>
                                        <div class="link">
                                            <a href="/antiCorruption/front/expertise/id/'.$data->id.'">Перейти к документу</a>
                                        </div>' . ($data->file ?
                                        '<div class="link">
                                            <a href="'.$data->getFileUrl($data->file).'">Скачать '.$data->originFile->ext.' '.File::getFileSize($data->file, "Mb").'</a>
                                        </div>' : '');
                            },
                            'htmlOptions'=>array(
                                'class'=>'max300'
