...
<head>
    ...
    $clientScript->registerScriptFile($assets . '/js/orphus.js', CClientScript::POS_END);
        ...
        <div class="header">
            <div class="head">
                <div class="wrap">
                    ...
                    <div class="lang">
                        <a href="http://tomsk.dpridprod.ru">РУС</a>
                        <a <?php echo (Yii::app()->language == 'en') ? 'class="active"' : ''?> href="http://investin.tomsk.dpridprod.ru">ENG</a>
                        <a <?php echo (Yii::app()->language == 'de') ? 'class="active"' : ''?> href="http://de.tomsk.dpridprod.ru">DE</a>                    </div>
                    ...
                    <div class="desc">
                        <div>
                            <span>
                                ...
                                ?>
                                <?php
                                if (in_array(Yii::app()->language, array('en', 'de'))) {
                                    echo Yii::t('app', 'Томской области'). '<br/>' . @$model->title;
                                } else {
                                    if ($model->alias == 'toipkro.tomsk.dpridprod.ru')
                                        echo @$model->title;
                                    else
                                        echo @$model->title . '<br/>' . Yii::t('app', 'Томской области');
                                }
                                ?>
