...
* [#9845](http://dev.ckeditor.com/ticket/9845): Fixed TAB NavItems in the [Link](http://ckeditor.com/addon/link) dialog window when the Anchor option is used and no anchors are available.
